      ...
      <section className="relative min-h-[85vh] flex items-center">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-accent/20 px-4 py-1.5 mb-5 border border-accent">
            ...
            <h1 className="font-display text-4xl font-bold leading-tight text-accent sm:text-5xl lg:text-6xl">
              Vakmanschap in
              <span className="block text-accent"> elke steen</span>
            </h1>
            <p className="mt-5 text-base sm:text-lg text-accent leading-relaxed max-w-lg">
              Van terras tot oprit — wij realiseren uw droomproject met oog voor detail en jarenlange ervaring.
            </p>
            <div className="mt-7 flex flex-col sm:flex-row gap-3">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-accent px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-accent/90 hover:gap-3 shadow-lg"
              >
              ...
              <a
                href="tel:0617432464"
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-accent px-6 py-3.5 text-sm font-semibold text-accent transition-colors hover:bg-accent/10"
              >
      ...
      <section className="bg-primary py-14 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h2 className="font-display text-3xl font-bold text-accent sm:text-4xl">Recente projecten</h2>
          </div>
